...
curl -i --location --request POST $TEST_URL --header 'Content-Type: application/json' --data "@curl/DepositMoney.json"
echo "Withdrawing money"
curl -i --location --request POST $TEST_URL --header 'Content-Type: application/json' --data "@curl/WithdrawMoney.json"
echo "Writing a check"
curl -i --location --request POST $TEST_URL --header 'Content-Type: application/json' --data "@curl/WriteCheck.json"
